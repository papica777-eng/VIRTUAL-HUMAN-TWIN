...
interface NexusState {
  ...
  // Global environment
  currentEnv: 'aeterna' | 'vivisector' | 'swarm' | 'vht';
  setCurrentEnv: (env: 'aeterna' | 'vivisector' | 'swarm' | 'vht') => void;
...
export const useAutoHealing   = () => useNexusStore((s) => s.autoHealing);
...
export const useCurrentEnv    = () => useNexusStore((s) => s.currentEnv);
